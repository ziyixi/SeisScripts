...
function generate_profile_points(latnpts,lonnpts, vnpts, lon1, lat1, dep1, lon2, lat2, dep2)
    # init rθϕ_new
    ngll_new = latnpts * lonnpts * vnpts
...
function run_interp( command_args::Dict{String,Any})
    ...
    # get xyz_new
    xyz_new=generate_profile_points(latnpts,lonnpts, vnpts, lon1, lat1, dep1, lon2, lat2, dep2)
