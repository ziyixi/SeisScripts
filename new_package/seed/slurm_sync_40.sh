...
#SBATCH --job-name sync_40      # you can give your job a name for easier identification (same as -J)
...
sampling_rate=10
logfile=/mnt/ls15/scratch/users/xiziyi/process_asdf/relocation/processed_for_first_iteration_validation_40.log
