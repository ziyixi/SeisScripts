...
if __name__ == "__main__":
    ...
    @click.option('--waveform_length', required=True, type=str, help="waveform length to cut (from event start time)")
    @click.option('--sampling_rate', required=True, type=str, help="sampling rate in HZ")
